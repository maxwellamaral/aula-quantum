...
Esta célula usa Qiskit (não disponível no navegador). [▶ Abrir notebook no Google Colab](https://colab.research.google.com/github/maxwellamaral/aula-quantum/blob/main/notebooks/00b-phases.ipynb) ou rode `uv run jupyter lab` localmente.
