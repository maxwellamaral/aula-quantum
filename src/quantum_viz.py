...
def plot_qsphere_interactive(statevector, auto_open=False, output_file='qsphere_interativa.html'):
    """
    ...
    # Abrir no navegador se solicitado (desabilitado por padrão: em servidores/VMs
    # sem GPU não há WebGL e abrir navegador durante o quarto render atrasa/falha)
    if auto_open:
